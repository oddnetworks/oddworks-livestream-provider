...
module.exports = (bus, client, transform) => {
	return args => {
		...
		if (secrets.livestream && secrets.livestream.apiKey && secrets.livestream.accountId && secrets.livestream.clientId) {
			creds.apiKey = secrets.livestream.apiKey;
			creds.accountId = secrets.livestream.accountId;
			creds.clientId = secrets.livestream.clientId;
		}
